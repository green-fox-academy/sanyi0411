...
void draw(int size, int color)
{
    ...
    SDL_Rect rectangle = {SCREEN_WIDTH/2 - (size/2), SCREEN_HEIGHT/2 - (size/2), size, size};
    SDL_SetRenderDrawColor(gRenderer, rand() % color, rand() % color, rand() % color, 255);
