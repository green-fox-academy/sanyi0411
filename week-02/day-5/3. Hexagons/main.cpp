...
void hexagon_fractal_2(int x, int y, int size)
{
    if (size < 5) {
        return;
    }
    ...
    hexagon_fractal_2(x + size / 6, y, size / 3);
    hexagon_fractal_2(x + size / 2, y, size / 3);
    hexagon_fractal_2(x, y + size / 3, size / 3);
    hexagon_fractal_2(x + 8 * size / 12, y + size /3, size / 3);
    hexagon_fractal_2(x + size / 6, y + 2 * size / 3, size / 3);
    hexagon_fractal_2(x + size / 2, y + 2 * size / 3, size / 3);
...
int main(int argc, char *args[])
{
    ...
    while (!quit) {
        ...
        hexagon_fractal_2(0, 0, SCREEN_WIDTH);
